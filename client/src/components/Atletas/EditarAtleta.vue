  ...
  <v-dialog v-model="dialog" class="text-center" max-width="900">
    ...
    <v-card rounded="md" :loading="dataCargando">
      ...
      <v-card-title v-if="!dataCargando">
        <span class="d-none d-sm-flex"> Editar Atleta </span>
        <b class="d-flex d-sm-none text-subtitle-1 font-weight-bold"> Editar Atleta </b>
        <v-spacer> </v-spacer>
        ...
        <v-container class="px-md-4">
          ...
          <v-row>
            <v-col class="px-3" cols="12" sm="6">
              ...
              prepend-icon="mdi-sale" type="text" :rules="reglas.nombre_beca" @click:clear="inputs.porcentaje_beca = 0"
