...
export default {
  ...
  methods: {
    ...
    getReporte(){
      var docDefinition = {
        content: [
          ...
          {text:'Asistencia a Entrenamiento en Detalle', bold:true, color: '#2196F3', fontSize: 16, margin: [ 0, 10, 0, 10 ]},
          {text: [{text:'Equipo: ', bold:true, color: '#2196F3'},{text:`${this.equipo}`}], fontSize: 14, margin: [ 0, 10, 0, 0 ]},
          {text: [{text:'Entrenamiento: ', bold:true, color: '#2196F3'},{text:`${this.entrenamiento.info_entrenamiento}`}], fontSize: 14, margin: [ 0, 5, 0, 20 ]},
    ...
    async getEntrenamientos() {
      ...
      // Quitamos el loader
      this.entrenamientos_cargando = false;
    },
